...
<body>
  <div id="wrapper">
    <!-- Menu Barra horizontal(Perfil, Configuiracion...) -->
    ...
    </nav> <!-- Fin Menu Barra horizontal(Perfil, Configuiracion...) -->
    ...
    <div id="page-wrapper">
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-header">estado <small>Reserva de habitacion </small></h1>
          </div>
        </div> <!-- /. ROW  -->                
				<?php
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed">
                          <button class="btn btn-primary" type="button">Cuartos reservados<span class="badge"><?php echo $r ; ?></span></button>										
                        </a>
                      </h4>
                    </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="collapsed">
                          <button class="btn btn-primary" type="button">Followers  <span class="badge"><?php echo $f ; ?></span></button>
                        </a>
                      </h4>
                    </div>
