      ...
      <div class="container-fluid">
        <div class="row" style="background: #E1B3B3;">
          <div class="col-md-5 col-sm-5">
            <h1 class="page-header" style="border-bottom: 0px; margin-bottom:5px;">Estados <small>Habitaciones</small></h1>
          </div>
        ...
        <div class="modal-body">
          <form autocomplete="off" id="frm" action="#">
            ...
            <div class="form-group">
              ...
              <input id="namestateh" name="namestateh" class="form-control" type="text" placeholder="Nombre del Medio" required>
            </div>
            <div class="form-row">
  ...
  <script type="text/javascript">
    ...
    */
    ...
    $(".btnew").click(function(e) {
      ...
      $("#titModal").html("Nuevo " + "<span>estado Ocupaci&oacute;n</span>"); //+ id);
    ...
    function deletetype(id) {
      $("#titModal").html("Eliminar " + "<span>estado Ocupaci&oacute;n</span>"); //+ id);
    ...
    function editatype(id) {
      $("#titModal").html("Edici&oacute;n " + "<span>estado Ocupaci&oacute;n</span>"); //+ id);
      $('input').prop('disabled', false);
      fillformulario(id);
