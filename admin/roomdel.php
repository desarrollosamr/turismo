    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li><a  class="active-menu" href="roomdel.php"><i class="fa fa-pencil-square-o"></i> Eliminar habitación</a></li>                   
      </div>
    </nav>
    <!-- /. NAV SIDE  -->
    <div id="page-wrapper" >
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-header">ELIMINAR HABITACIÓN<small></small></h1>
          </div>
        </div>                  
        <div class="row">                
                    ...
                    <div class='panel panel-primary text-center no-boder bg-color-blue'>
                      <div class='panel-body'>
                        ...
                        <h3>".$row['bedding']."</h3>
											...
											<div class='panel-footer back-footer-blue'>".$row['type']."</div>
										</div>
                  </div>";
								}
                      ...
                      echo
                       "<div class='col-md-3 col-sm-12 col-xs-12'>
                          <div class='panel panel-primary text-center no-boder bg-color-red'>
                            ...
                            <div class='panel-footer back-footer-red'>".$row['type']."</div>
                          </div>
                        </div>";
											}
							}
          ...
          ?>
			 ...
			 <!-- /. PAGE INNER(PÁGINA INTERIOR)-->
      </div>
      <!-- /. PAGE WRAPPER(NVOLTURA DE PÁGINA)-->
    </div>
    <!-- /. WRAPPER  -->
    <!-- JS Scripts-->
    <!-- jQuery Js -->
