      ...
      <div class="container-fluid">
        <div class="row" style="background: #E1B3B3;">
          <div class="col-md-5 col-sm-5">
            <h1 class="page-header" style="border-bottom: 0px; margin-bottom:5px;">Tipos habitaciones<small></small></h1>
          </div>
                  ...
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="#" type="button" class="btn btn-success btnew">
                        <i class="fa fa-plus fa-spin"> </i> Crear tipo habitaci&oacute;n
        ...
        <div class="modal-body">
          <form autocomplete="off" id="frm" action="#">
            ...
            <div class="form-group">
              ...
              <input id="nametype" name="nametype" class="form-control" type="text" placeholder="Nombre" required>
            </div>
            <div class="form-group">
              <label for="nomDcto">Descripci&oacute;n</label>
              <input id="destype" name="destype" class="form-control" type="text" placeholder="Descripcion" required>
            </div>
            <div class="form-row">
  ...
  <script type="text/javascript">
    ...
    */
    ...
    $(".btnew").click(function(e) {
      ...
      $("#titModal").html("Nuevo " + "<span>Tipo Habitaci&oacute;n</span>"); //+ id);          
        ...
        case '<?php echo openssl_encrypt("saveedit", COD, KEY); ?>':
          doAjax(function(serverResponse) {
            ...
            switch (serverResponse) {
              case '0':
                fillrow($("#action").val());
                mysweet("Exito: tipo habitaci&oacute;n Actualizado", "success");
                break;
              case '1':
          ...
          doAjax(function(serverResponse) {
            ...
            switch (serverResponse) {
              case '0':
                ...
                mysweet("Exito: tipo habitaci&oacute;n almacenada", "success");
                break;
              case '1':
                mysweet("Error: Nombre ya existe", "error");
                break;
    ...
    function deletetype(id) {
      $("#titModal").html("Eliminar " + "<span>Tipo Habitaci&oacute;n</span>"); //+ id);                             
    ...
    function fillformulario(id) {
      $("#action").val(id);
      $('#nametype').val($('#nom' + id).html());
      $('#destype').val($('#des' + id).html());
    }

    function fillrow(id) {
      $('#nom' + id).html($('#nametype').val());
      $('#des' + id).html($('#destype').val());
    }

    function editatype(id) {
      $("#titModal").html("Edici&oacute;n " + "<span>Tipo Habitaci&oacute;n</span>"); //+ id);
      $('input').prop('disabled', false);
      fillformulario(id);
