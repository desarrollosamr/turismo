    ...
    <div id="wrapper">
      ...
      <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
          <ul class="nav" id="main-menu">
            <li><a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Tablero de usuario</a></li>
          </ul>   
        </div>
      </nav>
      <!-- /. NAV SIDE  -->       
      <div id="page-wrapper" >
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 class="page-header">ADMINISTRADOR<small> cuentas </small></h1>
            </div>
          </div>               
          <?php
            include ('db.php');
                    ...
                    <div class="modal-content">
                      ...
                      <form method="post">
						...
						if(isset($_POST['in']))
						{
							...
							{
                echo' <script language="javascript" type="text/javascript"> alert("Adicion exitosa") </script>';							
							}
      ...
      <?php 
        if(isset($_POST['up']))
        {
          ...
          {
            echo' <script language="javascript" type="text/javascript"> alert("Actualizacion exitosa") </script>';								
          }				
          header("Location: usersetting.php");				
				}
				ob_end_flush();
