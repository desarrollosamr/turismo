    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          <li><a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Estado de la habitación</a></li>
          ...
          <li><a href="roomdel.php"><i class="fa fa-pencil-square-o"></i> Cualquier cosa</a></li>
        </ul>
      </div>
    </nav>  <!-- /. NAV SIDE  -->    
    <div id="page-wrapper" >
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-header">Disponible<small> Habitaciones</small></h1>
          </div>
        </div>
        <?php
					include ('db.php');
          ...
          while($row= mysqli_fetch_array($re))
          {
            ...
            switch ($id){
              case "Superior Room":
                ...
                $bkfooter=" back-footer-blue";
                break;
              case "Deluxe Room":
                $bgcolor =" bg-color-green";
                $bkfooter=" back-footer-green";
                break;
              case "Guest House":
                $bgcolor =" bg-color-brown";
                $bkfooter=" back-footer-brown";
                break;
              case "Single Room":
                $bgcolor =" bg-color-red";
                $bkfooter=" back-footer-red";
                break;       
            }
						echo "<div class='col-md-3 col-sm-12 col-xs-12'>
                    <div class='panel panel-primary text-center no-boder".$bgcolor."'>
                      <div class='panel-body'>
                        <i class='fa fa-users fa-5x'></i>
                        <h3>".$row['bedding']."</h3>
                      </div>
                      <div class='panel-footer ".$bkfooter."'>".$row['type']."</div>
                    </div>
                  </div>";
					}                   
         ?>
