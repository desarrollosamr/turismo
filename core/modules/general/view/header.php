...
<div class="banner-top">
		...
		<div class="btn-urgent"><a href="/turismo/hoteles/index.php?view=newclientrequest.php" class="btn btn-urgent" target="_blank"><span class="glyphicon glyphicon-home"></span> Registra tu negocio <i class="fa fa-hotel" aria-hidden="true"></i></a></div>
