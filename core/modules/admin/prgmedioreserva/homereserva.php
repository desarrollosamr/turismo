      ...
      <div class="container-fluid">
        <div class="row" style="background: #E1B3B3;">
          <div class="col-md-5 col-sm-5">
            <h1 class="page-header" style="border-bottom: 0px; margin-bottom:5px;">Medios <small>de reservas</small></h1>
          </div>
                  ...
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="#" type="button" class="btn btn-success btnew">
                        <i class="fa fa-plus fa-spin"> </i> Crear medio reserva
  ...
  <div class="modal fade" id="<?php echo 'modal' . $ntype; ?>" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #EBDEF0;border-radius: 10px;">
          <h4 id="titModal"> </h4>
        ...
        <div class="modal-body">
          <form autocomplete="off" id="frm" action="#">
            ...
            <div class="form-group">
              ...
              <input id="nomMedyo" name="nomMedyo" class="form-control" type="text" placeholder="Nombre del Medio" required>
            </div>
            <div class="form-row">
  ...
  <script type="text/javascript">
    ...
    */
    ...
    $(".btnew").click(function(e) {
      ...
      $("#titModal").html("Nuevo " + "<span>medio reserva</span>");
          ...
          doAjax(function(serverResponse) {
            ...
            switch (serverResponse) {
              case '0':
                ...
                mysweet("Exito: Medio de reserva almacenado", "success");
                break;
              case '1':
                mysweet("Error: Nombre ya existe", "error");
                break;
    ...
    function deletetype(id) {
      $("#titModal").html("Eliminar " + "<span>medio reserva</span>"); //+ id);
