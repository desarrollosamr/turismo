      ...
      <div class="container-fluid">
        <div class="row" style="background: #E1B3B3;">
          <div class="col-md-5 col-sm-5">
            <h1 class="page-header" style="border-bottom: 0px; margin-bottom:5px;">Ocupaciones <small>generales </small></h1>
          </div>
  ...
  <div class="modal fade" id="<?php echo 'modal' . $ntype; ?>" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #ABEBC6;border-radius: 5px;">
          <h4 id="titModal"> </h4>
        ...
        <div class="modal-body">
          <form autocomplete="off" id="frm" action="#">
            ...
            <div class="form-group">
              ...
              <input id="nomocupaciones" name="nomocupaciones" class="form-control" type="text" placeholder="Nombre del Medio" required>
            </div>
            <div class="form-row">
  ...
  <script type="text/javascript">
    ...
    */
    ...
    $(".btnew").click(function(e) {
      ...
      $("#titModal").html("Nuevo " + "<span>ocupaciones</span>");
    ...
    function deletetype(id) {
      $("#titModal").html("Eliminar " + "<span>ocupaciones</span>"); //+ id);
    ...
    function fillformulario(id) {
      $("#action").val(id);
      $('#nomocupaciones').val($('#nom' + id).html());
    }

    function fillrow(id) {
      $('#nom' + id).html($('#nomocupaciones').val());
    }

    function editatype(id) {
      $("#titModal").html("Edicion " + "<span>ocupaciones</span>"); // + id);
      $('input').prop('disabled', false);
      fillformulario(id);
