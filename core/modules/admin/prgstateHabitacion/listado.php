<?php
  ...
  $objstatehab = new clsestadohabitacion();
    ...
    <table class='table display table-striped table-bordered table-hover' style='width:100%' cellspacing='0'>
      ...
      <tbody>"; 
        foreach ($array as $value) {
          $srttable.= "
          <tr id='row" .$value['idEstadoh']."'>        
            <td id='nom".$value['idEstadoh']."'>"   .$value['nomEstado']. "</td>
            <td class='centro'>
              <a href='javascript:void(0);' class='btn btn-warning btn-sm fa fa-edit edit' onclick='editatype(".$value['idEstadoh'].")'title='Editar' type='button'></a>
            </td>
            <td class='centro'> 
              <a href='javascript:void(0);' class='btn btn-danger btn-sm fa fa-trash-o delete' onclick='deletetype(".$value['idEstadoh'].")'title='Editar' type='button'></a>        
            </td>
          </tr>";
        }    
        $srttable.="
