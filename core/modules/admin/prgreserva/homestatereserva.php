      ...
      <div class="container-fluid">
        <div class="row" style="background: #E1B3B3;">
          <div class="col-md-5 col-sm-5">
            <h1 class="page-header" style="border-bottom: 0px; margin-bottom:5px;">Estados <small> de reservas</small></h1>
          </div>
                  ...
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="#" type="button" class="btn btn-success btnew">
                        <i class="fa fa-plus fa-spin"> </i> Crear estado reserva
        ...
        <div class="modal-body">
          <form autocomplete="off" id="frm" action="#">
            ...
            <div class="form-group">
              ...
              <input id="nomstateReserva" name="nomstateReserva" class="form-control" type="text" placeholder="Nombre del Medio" required>
            </div>
            <div class="form-row">
  ...
  <script type="text/javascript">
    ...
    */
    ...
    $(".btnew").click(function(e) {
      ...
      $("#titModal").html("Nuevo " + "<span>estado reserva</span>");
          ...
          doAjax(function(serverResponse) {
            ...
            switch (serverResponse) {
              case '0':
                ...
                mysweet("Exito: Estado de reserva almacenado", "success");
                break;
              case '1':
                mysweet("Error: Nombre ya existe", "error");
                break;
    ...
    function deletetype(id) {
      $("#titModal").html("Eliminar " + "<span>estado reserva</span>"); //+ id);
    ...
    function fillformulario(id) {
      $("#action").val(id);
      $('#nomstateReserva').val($('#nom' + id).html());
    }

    function fillrow(id) {
      $('#nom' + id).html($('#nomstateReserva').val());
    }

    function editatype(id) {
      $("#titModal").html("Edicion " + "<span>estado reserva</span>"); // + id);
      $('input').prop('disabled', false);
      fillformulario(id);
