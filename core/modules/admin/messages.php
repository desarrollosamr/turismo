  ...
  <div id="wrapper">        
    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li><a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Boletines informativos</a></li>
    ...
    <div id="page-wrapper" >
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-header">Panel <small>Boletines informativos </small></h1>
          </div>
        </div> <!-- /. ROW  -->
				<?php
          include('db.php');
          $mail = "SELECT * FROM `tbcontact`";
          ...
          <div class="col-md-12">
            ...
            <div class="alert alert-info">
              <h3 class="alert-heading">Enviar las cartas de noticias a los seguidores</h3>              
