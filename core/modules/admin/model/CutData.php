...
class CutData {
	...
	public static function getCut(){
		...
		if(self::getCurrent()!=null){
			...
			echo "<p class='alert alert-warning'>Bienvenido al sistema, para iniciar debes crear un corte, se ha configurado para que los cortes se creen automaticamente todos los dias <b>1ro</b> de cada Mes.</p>";
		}
	}
