      ...
      <div class="container-fluid">
        <div class="row" style="background: #E1B3B3;">
          <div class="col-md-5 col-sm-5">
            <h1 class="page-header" style="border-bottom: 0px; margin-bottom:5px;">Mobiliario <small> para habitaciones </small></h1>
          </div>
                  ...
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="#" type="button" class="btn btn-success btnew">
                        <i class="fa fa-plus fa-spin"> </i> Crear mobiliario
  ...
  <div class="modal fade" id="<?php echo 'modal' . $ntype; ?>" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #BFEBEB;border-radius: 10px;">
          <h4 id="titModal"> <span>Mobiliario</span></h4>
        ...
        <div class="modal-body">
          <form autocomplete="off" id="frm" action="#">
            ...
            <div class="form-group">
              ...
              <input id="nomMobiliario" name="nomMobiliario" class="form-control" type="text" placeholder="Nombre del Mobiliario" required>
            </div>
            <div class="form-group">
              <label for="nomDcto">Descripci&oacute;n</label>
              <input id="desMobiliario" name="desMobiliario" class="form-control" type="text" placeholder="Descripcion del Mobiliario" required>
            </div>
            <div class="form-group">
              <label for="nomDcto">Precio</label>
              <input id="preMobiliario" name="preMobiliario" class="form-control" type="text" placeholder="Valor comercial" required>
            </div>
            <div class="form-row">
  ...
  <script type="text/javascript">
    ...
    */
    ...
    $(".btnew").click(function(e) {
      ...
      $("#titModal").html("Nuevo " + "<span>Mobiliario</span>");
        ...
        case '<?php echo openssl_encrypt("saveedit", COD, KEY); ?>':
          doAjax(function(serverResponse) {
            ...
            switch (serverResponse) {
              case '0':
                fillrow($("#action").val());
                mysweet("Exito: mobiliario Actualizado", "success");
                break;
              case '1':
              ...
              case '2':
                ...
                break;
              case '3':
                mysweet("Error: Descripci&oacute; no valido", "error");
                break;
              case '4':
                mysweet("Error: Precio no valido", "error");
                break;
            }
          });
          break;
          ...
          doAjax(function(serverResponse) {
            ...
            switch (serverResponse) {
              case '0':
                ...
                mysweet("Exito: mobiliario almacenado", "success");
                break;
              case '1':
                mysweet("Error: Nombre ya existe", "error");
                break;
    ...
    function deletetype(id) {
      $("#titModal").html("Eliminar " + "<span>Mobiliario</span>"); //+ id);
    ...
    function fillformulario(id) {
      $("#action").val(id);
      $('#nomMobiliario').val($('#nom' + id).html());
      $('#desMobiliario').val($('#des' + id).html());
      $('#preMobiliario').val($('#pre' + id).html());
    }

    function fillrow(id) {
      $('#nom' + id).html($('#nomMobiliario').val());
      $('#des' + id).html($('#desMobiliario').val());
      $('#pre' + id).html($('#preMobiliario').val());
    }

    function editatype(id) {
      $("#titModal").html("Edicion " + "<span>Mobiliario</span>"); // + id);
      $('input').prop('disabled', false);
      fillformulario(id);
