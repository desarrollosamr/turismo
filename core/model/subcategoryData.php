...
{
	public static $tablename = "tbsubcategoria";
	...
	// partiendo de que ya tenemos creado un objecto subcategoryData previamente utilizamos el contexto
	...
	public static function countMedicos($inicio)
  {
	...
	*/
	...
	public static function generaSubmenu($id)
	{
		$ss="";
		$sql="";
		$sql = "select * from ".self::$tablename." where estado = 1 and idcategoria =$id";
		...
		while($rx = mysqli_fetch_array($rr)){
			...
			$array1[$cn]->cons          = $cn;
			$array1[$cn]->id            = $rx['id'];
			$array1[$cn]->idCategoria   = $rx['idCategoria'];		
			$array1[$cn]->iconCategory  = $rx['iconCategory'];
			$array1[$cn]->nomsubCategory = $rx['nomsubCategory'];	
			//$array1[$cn]->pidepersona= $rx['pidepersona'];
			//$array1[$cn]->pidefecha  = $rx['pidepersona'];
			//$array1[$cn]->pidelugar  = $rx['pidepersona'];	
			$cn++;
		}
		return $array1;
	}
