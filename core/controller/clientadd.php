...
$roleid = 4;
$isactive = 1;
include_once('/home/u669320997/domains/gramtour.com.co/public_html/core/model/tbOrganizacionData.php');
if(count($_POST)>0){
	...
	if(!$result){
		...
		VALUES (?, ?, ?, ?, ?, ?)'); 
		mysqli_stmt_bind_param($sql, 'sssiii', $nomborg, $emailorg, $password, $admonhotel, $roleid, $isactive);
		$sql->execute();
	}else{
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td style="text-align: center";><a href="http://gramtour.com.co/index.php?view=creapass.php&client=' . $emailorg . '&clientid=' . $ulcli . '">Activar</a></td></tr>
	</tbody></table>
	';
