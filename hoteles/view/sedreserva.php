        ...
        if(isset($_POST['submit']))
        {
            ...
            else
            {
                ...
                if (mysqli_query($con,$newres))
                {
                    ...
                    require('d:\xampp_new\htdocs\turismo\vendor\phpmailer\phpmailer\src\Exception.php');
                    require('d:\xampp_new\htdocs\turismo\vendor\phpmailer\phpmailer\src\PHPMailer.php');
                    require('d:\xampp_new\htdocs\turismo\vendor\phpmailer\phpmailer\src\SMTP.php');
