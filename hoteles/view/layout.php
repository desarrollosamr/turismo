...
if(Session::getUID()!=""){
  ...
  header("location:index.php?module=hoteles");
}
?>
?>
...
<body>
	...
	<?php 
		...
		if(!isset($_GET['view'])){
			include "core/modules/hoteles/view/portada.php";
		}else{
			$valid=false;
			if(file_exists($file = "core/modules/hoteles/view/".$_GET['view']) && $_GET['view']!="client"){
