...
<head>
	<title>GRAMTour Módulo de Gestión de Clientes</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="row">
		<?php if(substr($_GET['view'],0,3)!="new"){ ?>
			  	<div class="col-sm-2 col-md-2 col-lg-2"><?php include_once("view/clientmenu.php"); ?></div>
		<?php }?>
			<div class="col-sm-10 col-md-10 col-lg-10">
				<?php
					if(!isset($_GET['view'])){
						...
						$valid=false;
						if(file_exists($file = "view/".$_GET['view'])){
