...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2021 a las 02:37:39
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_newProducto` (IN `pnom` VARCHAR(80), IN `FLOAT` ,, ``, ``, ``, IN `piva` FLOAT, IN `pprecio` FLOAT, IN `pcan` INT)  BEGIN
  DECLARE a int;
  set a = 20;
...
DROP TABLE IF EXISTS `tbdetalleregistroreserva`;
...
(1, 1, 1, 3, 'cama_a.jpg', '', 200, 1),
(2, 1, 2, 5, '', '', 180, 1),
(3, 1, 3, 5, '', '', 150, 1),
(4, 2, 1, 4, 'cama_b.jpg', '', 210, 1),
(5, 3, 2, 10, '', '', 250, 1);
