...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2021 a las 19:53:16
...
--
-- Base de datos: `bdbasehotelprueba`
--
CREATE DATABASE IF NOT EXISTS `bdbasehotelprueba` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bdbasehotelprueba`;
